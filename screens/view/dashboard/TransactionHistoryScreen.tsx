...
// const tabs1 = ['Purchases', 'Sales', 'Charges'];
// const screenWidth = Dimensions.get('window').width;
// const tabWidth = screenWidth / tabs1.length ;  // equal width per tab
...
//  useEffect(() => {
//     // Animate bubble position whenever selectedTab changes
//     const index = tabs1.indexOf(selectedTab);
//     Animated.spring(translateX, {
//       toValue: index * tabWidth,
//       useNativeDriver: true,
//       speed: 20,
...
//   useEffect(() => {
//     const index = ['Purchases', 'Sales', 'Charges'].indexOf(
//       activeTab,
//     );
...
//             <TouchableOpacity
//               key={key}
//               style={[styles.tabItem, { width: tabWidth -15}]}
//               onPress={() => {
